...
object RealtimeIngestToServingInTwoEngines extends Logging {
  val appId: String = "RealtimeIngestToServingInTwoEngines"
  ...
  private def workflow = {
    WorkflowInfo.newBuilder()
     ...
     .addEngines(
       ...
       .setOnDemandStreamServingEngine(getServingParam))
      .addRuntypes(
        RunType.newBuilder()
       .setId(1)

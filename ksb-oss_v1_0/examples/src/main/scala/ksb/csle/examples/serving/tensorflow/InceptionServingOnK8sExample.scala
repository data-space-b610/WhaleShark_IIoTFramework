...
object InceptionServingOnK8sExample extends Logging {
  val appId = "InceptionServingOnK8sExample"
  ...
  private def enginParam = {
    ...
    val modelBasePath = "/inception/model"

    val runner = OnDemandRunnerInfo.newBuilder()
      .setClsName("ksb.csle.component.runner.KubernetesServingRunner")
      .setKubernetesServingRunner(
          KubernetesServingRunnerInfo.newBuilder()
            .setPort(port)

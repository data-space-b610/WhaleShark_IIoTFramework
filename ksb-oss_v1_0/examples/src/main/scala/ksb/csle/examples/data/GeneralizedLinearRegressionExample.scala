...
import ksb.csle.common.proto.StreamOperatorProto.GeneralizedLinearRegressionInfo.FamilyType
import ksb.csle.common.proto.StreamOperatorProto.GeneralizedLinearRegressionInfo.LinkType

/**
 * Object to create GeneralizedLinearRegression workflow scenario as a protobuf message WorkflowInfo.
 * See {@link WorkflowInfo}.
 * This is used for test of GeneralizedLinearRegression workflow scenario.
 *
 * TODO: Support graphical user interface for easy workflow editing.
 */
object GeneralizedLinearRegressionExample extends Logging {
  val appId: String = "Data-GeneralizedLinearRegressionExample"
  ...
  private def workflow = {
    ...
    val infileInfo = FileInfo.newBuilder()
      .addFilePath(
        s"file:///${System.getProperty(
            "user.dir")}/input/input_generalizedlinearregression.csv"
        .replaceAll("\\\\", "/"))
    ...
    val outfileInfo = FileInfo.newBuilder()
      .addFilePath(
        s"file:///${System.getProperty("user.dir")}/output/result_generalizedlinearregression.csv"
        .replaceAll("\\\\", "/"))
      .setFileType(FileInfo.FileType.CSV)
      .setDelimiter(",")
      .build
    val operator1 = StreamOperatorInfo.newBuilder()
      .setId(2)
      .setPrevId(1)
      .setClsName("ksb.csle.component.operator.cleaning.GeneralizedLinearRegressionOperator")

...
object TrafficEndToEnd extends Logging {
  ...
  private def engin1Param = {
    ...
    val writer = StreamPipeWriterInfo.newBuilder()
      ...
      .setKafkaPipeWriter(
          ...
          .setBootStrapServers(kafkaServer)
          .setZooKeeperConnect(kafkaZookeeper)
          .setCheckpointLocation(s"file:///home/csle/ksb-csle/examples/output/kangnam/checkpoint/kafka1")
  ...
  private def engin2Param = {
    ...
    val writer1 = StreamPipeWriterInfo.newBuilder()
      ...
      .setKafkaPipeWriter(
          ...
          .setBootStrapServers(kafkaServer)
          .setZooKeeperConnect(kafkaZookeeper)
          .setCheckpointLocation(s"file:///home/csle/ksb-csle/examples/output/kangnam/checkpoint/kafka2")
    ...
    val writer2 = StreamPipeWriterInfo.newBuilder()
      ...
      .setKafkaPipeWriter(
          ...
          .setBootStrapServers(kafkaServer)
          .setZooKeeperConnect(kafkaZookeeper)
          .setCheckpointLocation(s"file:///home/csle/ksb-csle/examples/output/kangnam/checkpoint/kafka2_copy")

...
/**
 * Object to create EqualDepthBinning test workflow as a protobuf message WorkflowInfo.
 * See {@link WorkflowInfo}.
 * This is used for test of EqualDepthBinning workflow scenario.
 *
 * TODO: Support graphical user interface for easy workflow editing.
 */
object EqualDepthBinningExample extends Logging {
  ...
  private def workflow = {
    ...
    val outfileInfo = FileInfo.newBuilder()
      .addFilePath(
        s"file:///${System.getProperty("user.dir")}/output/result_equaldepthbinning.csv"
        .replaceAll("\\\\", "/"))
      .setFileType(FileInfo.FileType.CSV)
      .setDelimiter(",")
      .build
    val operator1 = StreamOperatorInfo.newBuilder()
      .setId(2)
      .setPrevId(1)
      .setClsName("ksb.csle.component.operator.cleaning.EqualDepthBinningOperator")

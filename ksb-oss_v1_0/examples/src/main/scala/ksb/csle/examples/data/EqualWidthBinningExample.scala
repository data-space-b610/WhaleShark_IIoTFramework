...
/**
 * Object to create EqualWidthBinning test workflow as a protobuf message WorkflowInfo.
 * See {@link WorkflowInfo}.
 * This is used for test of EqualWidthBinning workflow scenario.
 *
 * TODO: Support graphical user interface for easy workflow editing.
 */
object EqualWidthBinningExample extends Logging {
  val appId: String = "Data-EqualWidthBinningExample"
  ...
  private def workflow = {
    ...
    val infileInfo = FileInfo.newBuilder()
      .addFilePath(
        s"file:///${System.getProperty("user.dir")}/input/input_equaldepthbinning.csv"
        .replaceAll("\\\\", "/"))
      ...
      .addField(
        FieldInfo.newBuilder()
          .setKey("DATA1")
          .setType(FieldInfo.FieldType.LONG)
          .build())
      .addField(
        FieldInfo.newBuilder()
          .setKey("DATA2")
    ...
    val outfileInfo = FileInfo.newBuilder()
      .addFilePath(
        s"file:///${System.getProperty("user.dir")}/output/result_equalwidthbinning.csv"
        .replaceAll("\\\\", "/"))
      .setFileType(FileInfo.FileType.CSV)
      .setDelimiter(",")
      .build
    val operator1 = StreamOperatorInfo.newBuilder()
      .setId(2)
      .setPrevId(1)
      .setClsName("ksb.csle.component.operator.cleaning.EqualWidthBinningOperator")

...
object BatchTrafficDataInSingleEngine extends Logging {

  val appId: String = "Data-TrafficDataPreprocess"
  ...
  private[this] val masterMode = ConfigUtils.getConfig().envOrElseConfig("servers.spark.master")
  private[this] val deployMode = ConfigUtils.getConfig().envOrElseConfig("servers.spark.deploy")

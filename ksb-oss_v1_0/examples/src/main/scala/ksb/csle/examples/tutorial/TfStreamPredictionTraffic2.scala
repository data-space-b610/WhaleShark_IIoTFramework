...
object TfStreamPredictionTraffic2 extends Logging {
  val appId = "TfStreamPredictionTraffic2"
...
//      .build()
    ...
    val columnIdPath = s"file:///Users/yhlee/git-repo/ksb-csle/examples/input/traffic_columnNames.txt"
    val operator5 = StreamOperatorInfo.newBuilder()
      .setPrevId(4)
      .setId(5)
    ...
    val modelBasePath = s"file:///Users/yhlee/git-repo/ksb-csle/examples/models/rnn/model"

 ...
 */
object SimpleStreamJoinSplitExample extends App {
  val appId: String = "SimpleStreamJoinSplitExample"
...
//          .setKeyColumn("window")
    ...
    .addEngines(
      ...
      .setId(1)
      .setPrevId(0)
      .setEngineNickName("StreamJoinSplitEngine")

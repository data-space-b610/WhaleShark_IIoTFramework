...
object HandleRawDataStreamingEngine extends Logging {
  ...
  def getRawStreamingData: StreamJoinEngineInfo = {
    ...
    val jsonSamplePath = s"dataset/input/streamingRawJson.csv"
...
//    val sensorList = Seq.range(54, 63) ++ Seq(24,52,64,67,70,73,76,79,82,85,88,91,93)
    ...
    val columnNamePath = s"dataset/input/sensorTmp.csv"
    ...
    val outKafkaInfo = KafkaPipeWriterInfo.newBuilder()
      ...
      .setTrigger("5 seconds")
      .setFailOnDataLoss(false)
      .setCheckpointLocation("ckp/energy/kafka")
      .build
    ...
    val csvFilePath = "dataset/output/energy/raw/"
  ...
  def handleAggregateStreaming: StreamJoinEngineInfo = {
    val jsonSamplePath = s"dataset/input/aggr13Json.csv"
    ...
    val modelPath = s"/user/leeyh_etri_re_kr/dataset/rfModel/"
    val operator2 = StreamPipeOperatorInfo.newBuilder()
      .setId(103)
      .setPrevId(102)
...
//    val jsonSamplePath = s"dataset/input/aggr13Json.csv"
    val csvFilePath = s"dataset/output/energy/mlData/"
    val outFileInfo = FilePipeWriterInfo.newBuilder()
    ...
    val outKafkaInfo = KafkaPipeWriterInfo.newBuilder()
      ...
      .setTrigger("5 seconds")
      .setFailOnDataLoss(false)
      .setCheckpointLocation("ckp/energy/kafka2")
      .build

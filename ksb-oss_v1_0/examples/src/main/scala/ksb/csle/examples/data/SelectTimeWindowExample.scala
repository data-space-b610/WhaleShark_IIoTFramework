 ...
 */
object SelectTimeWindowExample extends Logging {
  val appId: String = "Data-SelectTimeWindowExample"
  ...
  private def workflow = {
    val selectTimeWindowInfo = SelectTimeWindowRowsInfo.newBuilder()
      .setTimeWindowValue(5)
      .build()
    val infileInfo = FileInfo.newBuilder()
      .addFilePath(
          s"file:///${System.getProperty("user.dir")}/input/result_timewindow.csv"
          .replaceAll("\\\\", "/"))
    ...
    val outfileInfo = FileInfo.newBuilder()
      .addFilePath(
          s"file:///${System.getProperty("user.dir")}/output/result_temp.csv"
          .replaceAll("\\\\", "/"))
      .setFileType(FileInfo.FileType.CSV)
      .setDelimiter(",")
      .build
    val operator1 = StreamOperatorInfo.newBuilder()
      .setId(2)
      .setPrevId(1)
      .setClsName("ksb.csle.component.operator.transformation.SelectWithTimeWindowOperator")
      .setSelectTimeWindowRows(selectTimeWindowInfo)
      .build

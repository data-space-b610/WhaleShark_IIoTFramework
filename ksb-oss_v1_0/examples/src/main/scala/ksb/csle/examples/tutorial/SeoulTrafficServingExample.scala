...
object SeoulTrafficServingExample extends Logging {
  val appId = "SeoulTrafficServingExample"
  ...
  private def enginParam = {
    ...
    val port = 8003
    val modelName = "seoul_traffic"
    val modelBasePath = "file:///home/csle/ksb-csle/examples/models/rnn/model"
